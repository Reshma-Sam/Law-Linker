...
const masterSchema = require('../Model/MasterModel'); // Import master schema

const jrAdvocateSchema = new mongoose.Schema({
  ...masterSchema.obj,
  usertype: { type: String, enum: ['advocate', 'jr.advocate'],default: "jr.advocate", required: true },
...
}, { collection: 'jr.advocates' }) // Save this model to the 'jradvocates' collection
