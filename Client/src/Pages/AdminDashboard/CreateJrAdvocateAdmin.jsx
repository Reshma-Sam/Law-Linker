...
function CreateJrAdvocateAdmin({ show, handleClose }) {
    ...
    const handleSignUp = async (e) => {
        ...
        try {
            const response = await axios.post(`${apiUrl}/auth/createJrAdvocate`, formData, {
                headers: {
            ...
            if (response.status === 201) {
                alert("Jr.Advocate created successfully!");
                handleClose();
            }
        } catch (error) {
    ...
    return (
        <Modal show={show} onHide={handleClose} dialogClassName="modal-dialog-centered custom-modal-signup p-0 border-0">
            ...
            <Modal.Title className="text-center signup-heading">Create Jr.Advocate</Modal.Title>
            <Modal.Body>
...
export default CreateJrAdvocateAdmin;
